...
mk_vpn()
{
        if [[ -z $IS_VPN_CONNECTED ]]; then
                if source "/config/guest/vpn_status.direct" 2>/dev/null; then
                        str="${SFVPN_EXIT_IP}                   "
                        VPN_DST="Exit IP address   : ${CDG}${str:0:15}"
...
print_banner()
{
        echo -e "${CDM}"
        cat <<'EOF'
   _____            ____            ____     ____ _    __   ______      __
  / ___/___  ____ _/ __/___ ___  __/ / /_   / __ ) |  / /  / ____/_  __/ /_  ___  _____
  \__ \/ _ \/ __ `/ /_/ __ `/ / / / / __/  / __  | | / /  / /   / / / / __ \/ _ \/ ___/
 ___/ /  __/ /_/ / __/ /_/ / /_/ / / /_   / /_/ /| |/ /  / /___/ /_/ / /_/ /  __/ /
/____/\___/\__, /_/  \__,_/\__,_/_/\__/  /_____/ |___/   \____/\__, /_.___/\___/_/
          /____/                                              /____/
EOF
        echo -e "${CN}"
        echo "For questions, please contact Pieter"
        echo "Help is needed! If you want to help making Segfault awesome, please contact Pieter"
        echo ""
}
...
[[ -z $IPPORT ]] && IPPORT="${CDC}Type ${CC}curl sf/port${CDC} for reverse port. (currently not working, use ngrok)"
